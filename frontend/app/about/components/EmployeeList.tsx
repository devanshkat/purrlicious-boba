...
const EmployeeList : React.FC<EmployeeListProps> = ({emList}) => {
  return (
    <div className="flex flex-col p-0 lg:p-5 w-[80%] items-center justify-center">
      ...
      <div className="flex flex-row items-center justify-center text-[396%] lg:text-[4rem] font-bold text-center text-black pb-5">Our Team</div>
