  ...
  return (
    <div className="flex flex-col justify-center items-center text-black">
        ...
        <div className='flex flex-col transition-all duration-500 ease-in-out rounded-[1.5em] text-center text-[#454545] p-10 w-[90%]'>
            <div className='flex flex-col xl:flex-row items-center m-3 h-[full] xl:h-[10vmin] bg-white rounded-[1.5em]'>
                <div className='p-1 w-full text-[3vmin]'>Aggie Recreation center</div>
                <div className="border-[0.25vmin] border-orange-400 w-[80%] xl:w-[0vmin] xl:h-[7vmin]"></div>
